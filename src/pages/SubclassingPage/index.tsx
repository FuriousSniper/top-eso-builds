    ...
    return (
        <div className="content">
            ...
            <div className="main">
                ...
                <div className="titleBanner stickyWrapper">
                    <div className="stickyBars">
                    ...
                    <div className="skillSearch">
                        <input type="text" placeholder="e.g. Deep Fissure" ref={searchInputRef} onChange={handleSearch} />
                        <button type="button" onClick={clearSearch} className="clearSearchButton">X</button>
                    </div>
                </div>
                    ...
                    <div className="skillLinesWrapper">
                        {Object.entries(groupedSkills).map((value: [string, Record<string, SubclassingSkillType[]>]) => {
                            return Object.keys(value[1]).map((skillLineName: string, key: number) => {
                                if (currentSearch !== "" && currentSearch !== undefined && currentSearch !== null) {
                                    const skills = value[1][skillLineName]
                                    const curatedSkills: SubclassingSkillType[]= []
                                    
                                    for (var i = 0; i < skills.length; i++) {
                                        if (skills[i].name.toLowerCase().includes(currentSearch)) {
                                            curatedSkills.push(skills[i])
                                        }
                                    }
                                    
                                    if (curatedSkills.length > 0) {
                                        return <SkillLineGroup skillLineName={skillLineName} skills={curatedSkills} key={key} class={value[0]} />
                                    }
                                }
                                else{
