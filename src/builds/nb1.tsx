...
const nb1: BuildType = {
    ...
    skills: {
        normalFront: [
            ...
            {
                skill: nbSkills[9],
                explanationHtml: "<p>Range burst damage skill. Requires 5 stacks to proc. Deals insane damage</p>"
            },
            {
                skill: nbSkills[4],
    ...
    generalInfo: "This build allows user to deal absolutely huge damage in short time. It's very mobile, so kiting around environment is easy. Thanks to siphoning attacks it can have infinite resources, if managed correctly. The downsite is that it is very squishy. If you stay in wrong place for too long or miss GCD due to some lag or other error, you will die very quickly. The build overall is very fun to play due to 1-shot potential, but it will be very difficult for inexperienced user.",
    lastUpdated: "U44",
    details:[
        {
            title: "Rotation",
        ...
        {
            title: "Race",
            htmlText: "<p>Any damage race works well. Orc offers addtional damage, healing an mobility, Breton and Imperial have very good sustain. Khajiit offers balance of sustain and damage. Wood elf has good stamina sustain and mobility.</p>"
        }
    ]
}
