...
const Sidebar = (props: SidebarProps) => {
    ...
    const openSide = props.side === "right" ? "openedRight" : "openedLeft"
    const sidebarSide = props.side === "right" ? "sidebarRight" : "sidebarLeft"
    const buttonClass = props.side === "right" ? "hideRight" : "hideLeft"
    ...
    return (
        <div className={classNames(
            "sidebarWrapper",sidebarSide, { [openSide]: isOpen }
        )}
        >
            {
                props.side==="right"&&
                <button className={classNames("hideTooltipButton", buttonClass)} onClick={toggleTooltip}>
                {!isOpen &&
